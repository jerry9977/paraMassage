...
@receiver(post_save, sender=m.ClientDetailInfo)
            ...
            async_to_sync(channel_layer.group_send)(
                'dashboard_consumer',
                {
                    ...
                    'payload':{
                        ...
                        'health_insurance_number': str(instance.client.health_insurance_number),
                        'reference_number': str(instance.client.reference_number),
